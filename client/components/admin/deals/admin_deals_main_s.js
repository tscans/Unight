...
import AdminDealsBodyS from './admin_deals_body_s';
...
class AdminDealsMainS extends Component {
	general(){
        	...
        	<div>
        		<div className="container-fluid bg-3 text-center">
	                ...
	                <div className="col-md-12">
	                	<AdminDealsBodyS orgSilverDeals={this.props.orgSilverDeals}/>
	                </div>
	            </div> 
        	</div>
        );
...
export default createContainer((props)=>{
    ...
    return {profile: Profile.findOne(), pages: Pages.findOne({_id: pageID}),
     orgSilverDeals: DandE.find({forPage: pageID}).fetch()}
