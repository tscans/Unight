    			...
    			<div className="lower"></div>
	    			<div className="col-md-10 col-md-offset-1">
					  <div className="form-group">
					    ...
					    <input type="text" className="form-control foc-card" ref="title" defaultValue={this.state.general.title} placeholder="Deal Title"/>
					  </div>
					  <div className="form-group">
					    <label htmlFor="exampleInputEmail1">Description</label>
					    <input type="text" className="form-control foc-card" ref="desc" defaultValue={this.state.general.desc} placeholder="Deal Description"/>
					  </div>
					  <div className="form-group">
					    <label htmlFor="exampleInputEmail1">Expiration</label>
					    <input type="text" className="form-control foc-card" ref="expi" defaultValue={this.state.general.expi} placeholder="Expiration"/>
					  </div>
					  <div className="form-group">
